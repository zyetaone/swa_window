...
export const AIRCRAFT = {
	...
	// Minimum angular velocity floor (rad/s) — prevents orbit from stalling on long straights
	MIN_ANGULAR_VELOCITY: 0.03,
...
export const FLIGHT_FEEL = {
	...
	BANK_ANGLE_MAX: 12.0,      // degrees max bank (dramatic tilt during turns)
	BANK_SMOOTHING: 2.5,       // lerp speed (smooth roll in/out)
	BANK_FACTOR: 1.2,          // turn rate → bank angle multiplier (higher = more responsive banking)
