 ...
 *
 * At 35,000 ft with ~60 deg FOV, the visible ground extends ~80km forward.
 * Orbit radius is ~0.25 deg = ~28km. Combined with padding: ~1.5 deg x 1.2 deg.
 */
 ...
 */
export function imageryZoomRange(_minAltitude: number, maxAltitude: number): { min: number; max: number } {
